"""
VOYNICH MANUSCRIPT MASTER WORKBENCH (ZERO-DEPENDENCY CONTAINER)
Pure Streamlit, Pandas, NumPy, and pure SVG.
Zero external visualization packages (no matplotlib, no seaborn).
"""
...
# ---------------------------------------------------------
# MASTER CORPUS LOADER (NO NETWORK CALLS)
# ---------------------------------------------------------
@st.cache_data
def load_corpus():
    candidate_files = [
        ...
        os.path.join("data", "voynich_active_table.csv")
    ]
    ...
    # Fallback pre-indexed records if no local file is detected
    sample_data = [
...
# =========================================================
# TAB 0: SPOT PIES (HARDCODED FIVE LOCI & EXPLODED BREAKOUT)
# =========================================================
with tabs[0]:
